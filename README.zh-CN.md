...
OpenKnack 把整个配置流程打包成**胶囊**（Capsule）— 引导式工作流，帮你：
...
| 平台 | 架构 | 下载 |
|------|------|------|
| macOS | Apple Silicon (arm64) | [**下载 v0.1.1**](https://github.com/kamiimeteor/OpenKnack/releases/latest) |

> Intel macOS、Windows、Linux 即将推出。

### 安装步骤

1. 从 [Releases](https://github.com/kamiimeteor/OpenKnack/releases) 页面下载 `.dmg`
2. 打开后将 **OpenKnack** 拖到「应用程序」文件夹
...
<p align="center">
  <img src="assets/screenshots/zh/01-home.png" alt="主页" width="700" />
</p>
<p align="center"><i>选择 Quick Start 或 Manual Mode</i></p>

<p align="center">
  <img src="assets/screenshots/zh/02-check-system.png" alt="检查系统" width="700" />
</p>
<p align="center"><i>第 1 步 — 检查系统环境</i></p>

<p align="center">
  <img src="assets/screenshots/zh/03-check-results.png" alt="检查结果" width="700" />
</p>
<p align="center"><i>环境扫描通过，可以继续</i></p>

<p align="center">
  <img src="assets/screenshots/zh/04-install-openclaw.png" alt="安装 OpenClaw" width="700" />
</p>
<p align="center"><i>第 2 步 — 预览安装计划</i></p>

<p align="center">
  <img src="assets/screenshots/zh/05-install-results.png" alt="安装结果" width="700" />
</p>
<p align="center"><i>OpenClaw 安装成功</i></p>

<p align="center">
  <img src="assets/screenshots/zh/06-connect-telegram.png" alt="连接 Telegram" width="700" />
</p>
<p align="center"><i>第 3 步 — 粘贴 Bot Token 连接 Telegram</i></p>

<p align="center">
  <img src="assets/screenshots/zh/07-telegram-token.png" alt="输入 Token" width="700" />
</p>
<p align="center"><i>Token 已填入，准备连接</i></p>

<p align="center">
  <img src="assets/screenshots/zh/08-setup-complete.png" alt="设置完成" width="700" />
</p>
<p align="center"><i>全部完成，附带完整操作回执</i></p>
...
发现 Bug？需要新的胶囊？[提交 Issue](https://github.com/kamiimeteor/OpenKnack/issues)。
